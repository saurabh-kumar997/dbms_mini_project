...
<label>Email</label><input type="Email" class="form-control" placeholder="Enter Email" name="user" value=""/>
<br><br>
<label>Pass</label><input type="text" class="form-control" placeholder="Enter Password" name="pass" value=""/>
<br><br>
...
if($_GET['submit']){
	...
	if($uname!="" && $pd!="")
	{
			$query="insert into admin values('','$uname','$pd') ";
